...
timeout = 10       # how much to wait between LLD and sending
...
if sys.argv[1] == 'get':
    time.sleep(timeout)  # wait for LLD to be processed by server
    ...
    print('  Note: the sender will fail if server did not gather LLD previously.')
else:
